...
$content = file_get_contents("../mailtemplate/wait_for_approve.html");


$mail->Subject = 'New Loan Documents for approve.';
$mail->Body    = $content; 
...
$mail->AltBody = 'You have new documents wait for approve';
