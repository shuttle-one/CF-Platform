...
if ($_SESSION['role'] == 'audit') {
    $sql = "select * from loan_documents_v2 where audit_approve=1";
    if ($config['TEST']==1)
      $sql .= " and test=1 ";
    else $sql .= " and test=0 ";
    $db->sql($sql);
    ...
    $sql = "select * from loan_documents_v2 where legal_approve=1";
    if ($config['TEST']==1)
      $sql .= " and test=1 ";
    else $sql .= " and test=0 ";
    $db->sql($sql);
                    ...
                    <table class="table table-border-horizontal">
                      ...
                      foreach($res as $r) { 
                        ...
                        <tr>
                          ...
                          <td><a class="btn btn-primary btn-sm" href="approved_loan_detail.php?id=<?=$r['id']?>" data-original-title="" title=""> <span class="fa fa-info-circle"></span> Detail</a></td>
                        </tr>
                      <? } ?>
