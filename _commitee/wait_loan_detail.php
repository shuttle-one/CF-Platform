...
body.loading .modal {
  ...
  <body>
                  ...
                  <div class="card-body">
                    <div class="row form-group">
                      <div class="col-sm-12 form-group">
                        <label>Score</label>
                        <input class="form-control" name="score" id="score" type="text" placeholder="" value="<?=$res[0]['score']?>">
                      </div>

                      <div class="col-sm-12 form-group">
                        <label>Debt</label>
                        <input class="form-control" name="debt" id="maxborrow" type="maxborrow" placeholder="" value="<?=$res[0]['max_borrow']?>">
                      </div>

                      <div class="col-sm-12 form-group">
                        <label>Apr/Year</label>
                        <input class="form-control" name="apr" id="apr" type="maxborrow" placeholder="" value="<?=$res[0]['apr']?>">
                      </div>

                    </div>
                    <button type="button" id="btn_approve" class="btn btn-success">Submit</button>
                    <button type="button" id="btn_reject" class="btn btn-danger">Reject</button>
              ...
              <? if (count($res)==1) { ?>
                ...
                <div class="card">
                      ...
                      <div class="card-body">
                          ...
                          <div class="form-group row">
                            <label class="col-sm-6 col-form-label" for="type">Invoice Type</label>
                            <div class="col-sm-6">
                          ...
                          <div class="form-group row">
                            <label class="col-sm-6 col-form-label" for="file1">Banker's Guarantee
                              </label>
                            <div class="col-sm-6">
                              <?if ($res[0]['file1']!='') { ?>
                          ...
                          <div class="form-group row">
                            <label class="col-sm-6 col-form-label" for="file2">Trade Invoice</label>
                            <div class="col-sm-6">
                              <?if ($res[0]['file2']!='') { ?>
                          ...
                          <div class="form-group row">
                            <label class="col-sm-6 col-form-label" for="file3">Month 1 Bank Statement</label>
                            <div class="col-sm-6">
                              <?if ($res[0]['file3']!='') { ?>
                          ...
                          <div class="form-group row">
                            <label class="col-sm-6 col-form-label" for="file4">Month 2 Bank Statement</label>
                            <div class="col-sm-6">
                              <?if ($res[0]['file4']!='') { ?>
    ...
    $("#btn_approve").click(function() {
        if (confirm("Are you sure to approve with every field you enter ? "))
            sendUpdate(2);
    });
    ...
    function sendUpdate(ap) {

        $body = $("body");
        $body.addClass("loading");

        var maxborrow = $("#maxborrow").val();
        var debit = $("#debit").val();
        var apr = $("#apr").val();
        var loanid = <?=$loandocid?>;
        var score = $("#score").val();

        $.ajax({
            url: "wait_loan_update.php",
            type: 'POST',
            data: {
                'id' : loanid,
                'm' : maxborrow,
            ...
            success: function (data) {
                ...
                {
                    alert("Success");
                    window.location.href = "wait_list.php";
                }else {
                    alert(data);
                }
